...
typedef enum _FX_SUB_MEDIA_TYPE {
	...
	IYUV,   		//!< 12 bits YUV Format. 8-bpp Y plane, followed by 8-bpp 2×2 U and V planes */
	...
	NV12,   		//!< 12 bits YUV Format. 8-bpp Y plane, followed by 8-bpp 2×2 interlaced U and V planes */

	NV21,   		//!< 12 bits YUV Format. 8-bpp Y plane, followed by 8-bpp 2×2 interlaced V and U planes */
