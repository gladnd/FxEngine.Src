...
namespace FEF {
    ...
    *//*-----------------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------------*//*!
	FEF_GetFxRunningState().

	The FEF_GetFxRunningState function gets the Fx running state (see FX_RUNNING_STATE).
    The running Fx states are STOP / START / PAUSE.

    @param hFxEngine:		Handle of the FxEngine instance.
	@param hFx:				Handle of the Fx plugin.
	@param pFxRunningState:	Pointer to a variable that receives the Fx plugin
							   state (see FX_RUNNING_STATE).
		       
	@return	FX_OK if success, otherwise an FX error code.
    *//*-----------------------------------------------------------------------*/
	FXENGINE_EXP Int32 FXENGINE_API FEF_GetFxRunningState(	/* [in] */FX_HANDLE hFxEngine,
									/* [in] */FX_HANDLE hFx,
									/* [out] */FX_RUNNING_STATE* pFxRunningState);

	/*----------------------------------------------------------------------*//*!
	FEF_GetFxState().

	The FEF_GetFxState function gets the Fx internal state (see FX_STATE).
    The Fx internal states are managed by IFxState interface.
    ...
    *//*-----------------------------------------------------------------------*/
	...
	The FEF_AttachFxObserver function defines callbacks to get States and Notes
	of any Fx.
	See IFxState and IFxNote interfaces.

    @param hFxEngine:			Handle of the FxEngine instance.
	
	@param pFxStateCallback:	Can be NULL. Pointer to a CFxStateCallback object containing
								the callback method receiving messages related to the
								progress of the Fx states.
	@param pFxNoteCallback:		Can be NULL. Pointer to a CFxNoteCallback object containing
								the callback method receiving messages related to the
								progress of the Fx notes.
    ...
    *//*-----------------------------------------------------------------------*/
	FXENGINE_EXP Int32 FXENGINE_API FEF_AttachFxObserver(/* [in] */FX_HANDLE hFxEngine,
										...
										/* [in] */CFxNoteCallback* pFxNoteCallback,
										/* [in] */FX_PTR dwParam,
	...
	The FEF_AttachFxObserverEx function defines callbacks to get States and Notes
	of any Fx.
	See IFxState and IFxNote interfaces.
	...
	@param pFxStateCallback:	Can be NULL. Pointer to a CFxStateCallback object containing
								the callback function receiving messages related to the
								progress of the Fx states.
	@param pFxNoteCallback:		Can be NULL. Pointer to a CFxNoteCallback object containing
								the callback function receiving messages related to the
								progress of the Fx notes.
    ...
    *//*-----------------------------------------------------------------------*/
	FXENGINE_EXP Int32 FXENGINE_API FEF_AttachFxObserverEx(	/* [in] */FX_HANDLE hFxEngine,
											...
											/* [in] */FXNOTECALLBACK* pFxNoteCallback,
											/* [in] */FX_PTR dwParam,
											/* [out] */FX_HANDLE* phObserverId);
	...
	The FEF_DetachFxObserver method detaches observer added with both FEF_AttachFxObserver 
	and FEF_AttachFxObserverEx functions.
