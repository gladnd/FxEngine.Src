...
*//*!
   ...
   IFxState interface allows to a Fx plugin to publish Fx internal states
...
typedef Void (FEF_CALLBACK FXSTATECALLBACK)(FX_STATE FxState, FX_HANDLE hFx, FX_HANDLE hObserverId, FX_PTR dwParam);

//! State Callback object
class FXENGINE_EXP CFxStateCallback {
public:
	virtual Void FxStateCallback(FX_STATE FxState, FX_HANDLE hFx, FX_HANDLE hObserverId, FX_PTR dwParam);
};
