...
{
public:
	static CNotifyObjects* Create( FX_PTR qParam1 = NULL, FX_PTR qParam2 = NULL)
	{
		return new CNotifyObjects( qParam1, qParam2);
	}
...
private:
	//!Use Create instead
	CNotifyObjects( FX_PTR qParam1 = NULL, FX_PTR qParam2 = NULL)
		: _qParam1( qParam1), _qParam2( qParam2)
	{}
	//!Use Destroy instead
	~CNotifyObjects()
	{}
