...
Void CFxStateCallback::FxStateCallback(FX_STATE FxState, FX_HANDLE hFx, FX_HANDLE hObserverId, FX_PTR dwParam)
{return;}

Void CFxNoteCallback::FxNoteCallback(const std::string strNote, FX_HANDLE hFx, FX_HANDLE hObserverId, FX_PTR dwParam)
{return;}
