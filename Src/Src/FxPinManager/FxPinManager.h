...
public:
	...
	virtual Int32 GetPinCount(Uint16& wPinCount, Bool ShouldProtect = TRUE);
	virtual Int32 GetPin(IFxPin** ppIFxPin, Uint16 wPinNumber, Bool ShouldProtect = TRUE);
...
private:
	Int32 RemoveInPin(IFxPin* pFxPin);
	Int32 RemoveOutPin(IFxPin* pFxPin);
	Void ClearFxPinList();
